...
//go:generate go tool mockgen -source item/catalog_grpc.pb.go -destination item/mock/catalog_grpc.pb.go -package mockitem
//go:generate go tool mockgen -source matchmaking/request_match.pb.go -destination matchmaking/mock/request_match.pb.go -package mockmatchmaking
